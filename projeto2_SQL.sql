...
--14. Selecione os departamentos com um orçamento maior do que o orçamento médio de todos os departamentos.
...
--Porque precisa escrever de qual tabela vem aquela coluna que será feita a média
SELECT  nome, Avg(orcamento)
FROM Departamentos
GROUP BY nome, orcamento
HAVING orcamento >  (Select AVG(orcamento))
